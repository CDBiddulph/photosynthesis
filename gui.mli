...
(** [init cells] is the GUI for a board of cells, constructed from the
    ground up. A hexagon will be created in every place corresponding to
    a Some value in [cells]. Then, [update_cells cells] will be called. *)
val init : Cell.t option list -> t
...
val update_cells : t -> Cell.t option list -> t
